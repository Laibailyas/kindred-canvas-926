    ...
    <section id="faq" className="relative bg-paper px-5 py-16 text-ink sm:px-6 sm:py-24 md:py-32">
      <div className="mx-auto grid max-w-[1800px] grid-cols-1 gap-9 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
        ...
        >
          ...
          <p className="mt-8 text-sm font-medium text-ink md:text-base">
            Have more questions?{" "}
            <a
              href="mailto:apply@dotis.ai"
              className="text-flare underline decoration-flare/40 underline-offset-4 transition-colors hover:text-ink hover:decoration-ink/40"
            >
              Reach out to us.
            </a>
          </p>
